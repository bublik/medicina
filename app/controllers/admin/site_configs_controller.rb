class Admin::SiteConfigsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     User: create, read, update, destroy, custom_action
  #
  #   editor:
  #     User: create, read, update, custom_action_for_an_item
  #
