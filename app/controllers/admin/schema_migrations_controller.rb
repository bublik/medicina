...
class Admin::SchemaMigrationsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     SchemaMigration: create, read, update, destroy, custom_action
  #
  #   editor:
  #     SchemaMigration: create, read, update, custom_action_for_an_item
  #
