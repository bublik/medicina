...
class Admin::SessionsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Sessions: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Sessions: create, read, update, custom_action_for_an_item
  #
