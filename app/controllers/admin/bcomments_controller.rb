...
class Admin::BcommentsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Bcomment: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Bcomment: create, read, update, custom_action_for_an_item
  #
